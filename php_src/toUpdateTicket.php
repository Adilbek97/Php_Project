  ...
  $link = mysqli_connect($host, $user, $password, $database) 
             ...
             $query ="SELECT user_password FROM tickets WHERE number_of_ticket='$number_ticket'";
              ...
              if($result)
              {
                ...
                if($rows==0){
                  echo "такого билета нет.";
                  }else{
                  $row = mysqli_fetch_row($result);
                  if($row[0]==$password_t){
                          echo "<p style='color: green;'>ваш билет верно</p>";
                          setcookie ("toUpdateTicket", $number_ticket);
                          header("Location: updateTicket.php");
                  }else{
                  echo "пароль почта не верно";
                }
                }
...
<br>
    ...
    <div class="container ">
      <form class="clform" action="toUpdateTicket.php" method="POST">
        <div class="form-group">
      ...
      <div class="form-group">
       ...
       <div class="btn">
                <button type="submit" name="btnNext" class="btn btn-success">далее</button>
      </form>
